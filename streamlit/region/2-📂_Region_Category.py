...
st.subheader("📊 Region") 
st.title("📂 Region & Category Analysis")

df = get_gold_table("region_category")
...
category_options = ["Show All Categories"] + list(df["Category"].unique())
...
if selected_category != "Show All Categories":
    filtered_df = filtered_df[filtered_df["Category"] == selected_category]

region_title_part = selected_Region if selected_Region != "Show All Regions" else "All Regions"
category_title_part = selected_category if selected_category != "Show All Categories" else "All Categories"
...
if not filtered_df.empty: 
    ...
    x_axis = "Region" if selected_category != "Show All Categories" and selected_Region == "Show All Regions" else "Category"
    
    fig = px.bar(
        filtered_df, 
        x=x_axis,    
        y=active_metric,
        hover_name="Region" if x_axis == "Category" else "Category",  
        title=chart_title, 
